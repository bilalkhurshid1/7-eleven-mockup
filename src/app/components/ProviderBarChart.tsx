...
const dataByProvider = [
  { name: 'AWS', value: 2100000, color: '#008163' },
  { name: 'Azure', value: 1400000, color: '#F4811F' },
  { name: 'GCP', value: 500000, color: '#EE2526' },
  { name: 'OCI', value: 200000, color: '#ff8d8d' },
];

const dataByCostType = [
  { name: 'Compute', value: 1800000, color: '#008163' },
  { name: 'Storage', value: 1200000, color: '#F4811F' },
  { name: 'AI/ML', value: 700000, color: '#EE2526' },
  { name: 'Networking', value: 500000, color: '#ff8d8d' },
];

const dataByBusinessUnit = [
  { name: 'Retail', value: 1500000, color: '#008163' },
  { name: 'IT', value: 1100000, color: '#F4811F' },
  { name: 'Accounting', value: 800000, color: '#EE2526' },
  { name: 'Supply Chain', value: 600000, color: '#ff8d8d' },
  { name: 'Digital Products', value: 200000, color: '#005544' },
];
